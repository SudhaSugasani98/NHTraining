...
namespace Hospital
{
    ...
    class Diagnosists
    {
        ...
        private int fee;
        private int patientserialnumber;
        private string typeofdiagnosists;
        public void AddDiagnosistsdetails()
        {
            //Todo
        }
        public void EditDiagnosistsdetails()
        {
            //Todo
        }
        public void DeleteDiagnosistsdetails()
        {
            //Todo
        }
        public void DisplayDiagnosistsdetails()
        {
            //Todo
        }
    }
