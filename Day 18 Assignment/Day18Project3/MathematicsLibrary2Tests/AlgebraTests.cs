...
namespace MathematicsLibrary2.Tests
{
    [TestClass()]
    public class AlgebraTests
    {
        ...
        /// <summary>
        /// This method will check if the given number is palindrome or not
        /// </summary>
        [TestMethod()]
        public void Palindrome_or_Not_Test()
        {
            //Arrange
            int input = 121;
            bool expected = true;
            //Act
            bool actual = Algebra.isPalindromeorNot(input);
            //Assert
            Assert.AreEqual(expected,actual);
        }
    }
